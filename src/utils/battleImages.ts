...
export const getBattleImage = (battleId: string): string => {
  ...
  const battleMap: Record<string, string> = {
    ...
    'eger': 'eger',
    'maritsa-2': 'maritsa-2',
    'world-war-i': 'ww1-all-fronts',
    'ww1-all-fronts': 'ww1-all-fronts',
    'ottoman-fronts': 'ww1-all-fronts',
    // City conquests
    'sofia': 'sofia',
    ...
    'nicaea': 'bursa',
    'nicomedia': 'bursa',
    'gallipoli-conquest': 'gallipoli',
    'trebizond': 'trebizond',
    'bosnia': 'bosnia',
    'otranto': 'lepanto',
    'belgrade-conquest': 'belgrade',
    'budapest': 'mohacs',
    'algiers': 'preveza',
    'tunis': 'tunis',
    'tbilisi': 'chaldiran',
    ...
    'basra': 'baghdad',
    'karacahisar': 'bapheus',
    'yerevan-recapture': 'chaldiran',
    'baghdad-recapture': 'baghdad'
  };
